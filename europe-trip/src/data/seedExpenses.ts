...
export const seedExpenses: Expense[] = [
  ...
  {
    id: 'hotel-nuremberg-actual',
    amount: 1719,
    currency: 'EUR',
    category: 'accommodation',
    description: 'Sheraton Carlton Nuremberg (Jun 22–29, 7 nights)',
    city: 'Nuremberg',
    date: '2026-06-29',
    savedAt: '2026-07-17T00:00:00.000Z',
    budgetItemId: 'hotel-nuremberg',
  },
  {
    id: 'nuremberg-special-dinner',
    amount: 87.87,
    currency: 'USD',
    category: 'food',
    description: 'Special dinner',
  ...
  {
    id: 'nuremberg-vgn-transit',
    amount: 45,
    currency: 'USD',
    category: 'local-transport',
    description: 'VGN transit pass',
    city: 'Nuremberg',
    date: '2026-06-29',
    savedAt: '2026-07-17T00:00:00.000Z',
    budgetItemId: 'transit-nuremberg',
  },
  {
    id: 'nuremberg-food',
    amount: 96.02,
    currency: 'USD',
    category: 'food',
    description: 'Nuremberg food',
    city: 'Nuremberg',
    date: '2026-06-29',
    savedAt: '2026-07-17T00:00:00.000Z',
    budgetItemId: 'food-nuremberg',
  },
  {
    id: 'nuremberg-contingency',
    amount: 33.33,
    currency: 'USD',
    category: 'misc',
    description: 'Contingency / unexpected costs',
    city: 'Nuremberg',
    date: '2026-06-29',
    savedAt: '2026-07-17T00:00:00.000Z',
    budgetItemId: 'contingency',
  },
];
